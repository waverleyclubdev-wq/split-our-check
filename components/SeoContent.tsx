...
import AdBanner from "@/components/AdBanner"; // <-- 1. Ad banner component imported here
...
//       {/* Middle Ad Space */}
//       <div className="w-full max-w-[728px] h-[90px] mx-auto bg-slate-200 border border-slate-300 border-dashed rounded-lg flex items-center justify-center text-slate-500 text-sm tracking-widest uppercase mb-24">
